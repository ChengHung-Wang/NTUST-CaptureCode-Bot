...
# 0. 自動建立所需的資料夾
# ==========================================
directories = ['correct', 'wrong', 'captchas']
...
for i in range(10):
    ...
    # [步驟 A] 抓取圖片與 Hash
    time_get = time.time()
    hash_id = subprocess.getstatusoutput('php spider.php')[1]
    ...
    correct_prediction = subprocess.getstatusoutput(f'php spider.php {hash_id} {predict}')[1]
